#!/usr/bin/env python3
"""GHYSJ-TNF docking v5 wrapper.
Uses Scripps ADFR Suite prepare_receptor for 2AZ5; ligands are prepared by Meeko.
This wrapper patches the established v1 pipeline without changing the docking box,
ligand list, Vina settings, or interpretation rules.
"""
...
with tempfile.TemporaryDirectory() as td:
    patched = Path(td) / "run_patched_v5.py"
